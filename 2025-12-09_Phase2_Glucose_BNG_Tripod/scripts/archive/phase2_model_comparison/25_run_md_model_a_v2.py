...
============================================
Uses same approach as Model B simulation
"""
...
def run_md_simulation(receptor_pdb, ligand_mol, output_prefix,
    ...
    """Run MD simulation with OpenMM - same approach as Model B"""
    print("\n" + "=" * 60)
    ...
    # Merge protein and ligand (same method as Model B)
    ...
    for temp in [50, 100, 150, 200, 250, 300, temperature_k]:
        ...
        simulation.step(1000)  # 2 ps at each temperature
    ...
    # Equilibration with smaller timestep initially
    print(f"\n   Equilibrating for {equil_ns} ns...")
    # Run equilibration in chunks to catch errors early
    chunk_size = 10000
    ...
    # Production
    print(f"   Running production for {total_ns - equil_ns} ns...")
