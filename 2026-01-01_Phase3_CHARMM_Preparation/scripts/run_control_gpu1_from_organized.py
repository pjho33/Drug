...
SYSTEM_DIR = '/home/pjho3tr/projects/Drug/phase3_glycosylation/control_final'
GPU_INDEX = '1'
CHECKPOINT_FILE = 'prod_control_base.chk'
OUTPUT_DCD = 'prod_control_base.dcd'
OUTPUT_LOG = 'prod_control_base_log.csv'
TOTAL_STEPS = 50000000
TEMPERATURE = 310*kelvin

print("="*80)
print("CONTROL BASE SYSTEM - GPU 1")
print("="*80)
...
final_pdb = 'prod_control_base_final.pdb'
