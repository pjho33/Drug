...
OUTPUT_PNG = os.path.join(RESULTS_DIR, "tripod_100ns_plots.png")
...
def main():
    ...
    fig.suptitle('Tripod MD Simulation Analysis (100 ns)', fontsize=16, fontweight='bold')
    ...
    ax1.plot(arm_data['time_ns'], arm_data['arm3_A'], 'g-', label='Arm 3', linewidth=1, alpha=0.7)
    ...
    # 2. Max arm length
    ax2 = axes[0, 1]
    ax2.plot(arm_data['time_ns'], arm_data['max_arm_A'], 'purple', linewidth=1, alpha=0.8)
    ...
    ax3 = axes[0, 2]
    ax3.plot(arm_data['time_ns'], arm_data['Rg_A'], 'orange', linewidth=1, alpha=0.8)
    ...
    ax5 = axes[1, 1]
    ax5.hist(arm_data['arm1_A'], bins=30, alpha=0.6, label='Arm 1', color='blue', edgecolor='black')
    ax5.hist(arm_data['arm2_A'], bins=30, alpha=0.6, label='Arm 2', color='red', edgecolor='black')
    ax5.hist(arm_data['arm3_A'], bins=30, alpha=0.6, label='Arm 3', color='green', edgecolor='black')
